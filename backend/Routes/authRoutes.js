...
const { signup,verifyOtp,setPassword,login,getPreviousData,postBooking,Orders,getDashboardData,getBookedSeats,uploadImage,addMovie,getSeatsPercentage} = require("../controller/authController");
